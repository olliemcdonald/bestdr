...
## ----birthdeath-databeforeandafter, warning=FALSE-----------------------------
head(dat)
...
## ----birthdeath-runsampler, warning=FALSE, message=FALSE----------------------
...
## ----resistant-setup, warning=FALSE, message=FALSE----------------------------
b <- 0.10
...
## ----resistant-doseresponse-plot, warning=FALSE, message=FALSE, echo=FALSE----
...
## ----resistant-simulation, warning=FALSE, message=FALSE-----------------------
d_curve <- function(lc, d0, dd, dh, d50) d0 + dd - dd / (1 + exp(dh * (lc - d50)))
...
## ----resistant-procmodel, warning=FALSE, message=FALSE------------------------
model <- process_model(
...
## ----resistant-run, warning=FALSE, message=FALSE, eval=FALSE------------------
#  prior.list <- list(
#    mu_b1 = 0.1,
#    s_b1 = 0.05,
#    mu_b2 = 0.1,
...
## ----resistant-hierarchical, warning=FALSE, message=FALSE, eval=FALSE---------
#  model <- process_model(
#    bp_model(transition(name = "birth_1", parent = 1, offspring = c(2, 0)),
#             transition(name = "death_1", parent = 1, offspring = c(0, 0),
#                        model = "death_1 ~ d0_1 + dd_1  - dd_1 / (1 + exp(dh_1 * (x - d50_1)))"),
...
## ----resistant-1typehier, warning=FALSE, message=FALSE, eval=FALSE------------
#  model <- process_model(
