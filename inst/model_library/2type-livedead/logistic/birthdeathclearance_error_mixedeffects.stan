...
transformed parameters{
  ...
  bi = mu_bi + s_bi * bi_raw;
  db = mu_db + s_db * db_raw;
  b50 = mu_b50 + s_b50 * b50_raw;
  bh = mu_bh + s_bh * bh_raw;
  d0 = mu_d0 + s_d0 * d0_raw;
  dd = mu_dd + s_dd * dd_raw;
  d50 = mu_d50 + s_d50 * d50_raw;
  dh = mu_dh + s_dh * dh_raw;
  k = mu_k + s_k * k_raw;
